...
I18N["zh-Hans"] = {
  ...
  "* Customize the property guide that will be created.": "* 选择标注的属性和显示位置.",
    ...
    "Position Left"                                     : "左侧",
    "Show position:"                                    : "显示位置:",
    "Color hex, E.g. #FFFFFF 100%"                      : "Color hex, 例如. #FFFFFF 100%",
    "ARGB hex, E.g. #FFFFFFFF"                          : "ARGB hex, 例如. #FFFFFFFF",
    "RGBA CSS, E.g. rgba(255, 255, 255, 1)"             : "RGBA CSS, 例如. rgba(255, 255, 255, 1)",
    "Color format:"                                     : "颜色格式:"
};
